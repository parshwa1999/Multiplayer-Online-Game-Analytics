...
export JAVA_HOME=/home/thomasshelby/jdk
export HADOOP_HOME=/opt/hadoop
export HADOOP_CONF_DIR=/opt/hadoop/etc/hadoop
export HADOOP_LOG_DIR=/opt/hadoop/log
export HDFS_NAMENODE_USER=thomasshelby
export HDFS_DATANODE_USER=thomasshelby
export HDFS_SECONDARYNAMENODE_USER=thomasshelby
export YARN_RESOURCEMANAGER_USER=thomasshelby
export YARN_NODEMANAGER_USER=thomasshelby
